...
import { GitHubAddressesFilesService, GitHubFileItem } from "@klyte45/adr-commons";
...
export const NamesetGitHubSelectorCmp = ({ actionButtons, onBack }: Props) => {
    const buttonsRowContent = <>
        ...
        <button className="neutralBtn" onClick={() => GitHubAddressesFilesService.goToRepository()}>{translate("githubLibrary.visitRepository")}</button>
    </>
